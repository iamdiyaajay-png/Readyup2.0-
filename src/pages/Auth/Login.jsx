    ...
    <div className="min-h-screen bg-brand-bg flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 space-y-4">
        ...
        <div className="glass-card p-8 rounded-3xl border border-brand-border text-center">
          ...
          {success && (
            <div className="mt-5 p-4 rounded-xl bg-green-950/20 border border-green-900/30 text-green-400 text-xs font-medium">
              {success}
            </div>
          )}
          ...
          <form onSubmit={handleEmailSignIn} className="mt-6 space-y-4 text-left">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center ml-1">
                <label className="text-[11px] font-bold text-brand-text-secondary uppercase tracking-wider">Password</label>
                <button 
                  type="button" 
                  onClick={handleForgotPassword}
                  disabled={loading === 'reset'}
                  className="text-[10px] text-brand-accent hover:underline focus:outline-none disabled:opacity-50"
                >
