...
import { GraduationCap, Briefcase, Sparkles, Shield } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10 space-y-4">
        ...
        <div className="glass-card p-8 rounded-3xl border border-brand-border text-center">
          ...
          <p className="text-sm text-brand-text-secondary mt-2">
            Choose how you're signing in. We'll take you to the right dashboard.
          </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-center">
              <h3 className="font-bold text-sm text-brand-text-primary">Student</h3>
          ...
          >
            ...
            <div className="text-center">
              <h3 className="font-bold text-sm text-brand-text-primary">Mentor</h3>
              <p className="text-[10px] text-brand-text-secondary mt-1 leading-relaxed">
                Manage students & sessions
              </p>
            </div>
            {loading === 'mentor' ? (
