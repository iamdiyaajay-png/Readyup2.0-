...
import { GraduationCap, Briefcase, Sparkles, Mail, Lock, User } from 'lucide-react';
...
export default function SignUp() {
  ...
  const handleEmailSignUp = async (e) => {
    ...
    try {
      ...
      // Wait for auth state change to route to verification
    } catch (err) {
    ...
    <div className="min-h-screen bg-brand-bg flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 space-y-4">
        ...
        <div className="glass-card p-8 rounded-3xl border border-brand-border text-center">
          ...
          <form onSubmit={handleEmailSignUp} className="mt-6 space-y-4 text-left">
