...
export default function AdminLogin() {
  ...
  // Random names to evade aggressive autofill heuristics
  const [emailFieldName] = useState(() => Math.random().toString(36));
  const [passwordFieldName] = useState(() => Math.random().toString(36));
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="glass-card p-10 rounded-3xl border border-red-900/20">
          ...
          <form onSubmit={handleAdminLogin} className="space-y-4" autoComplete="off">
            {/* Dummy fields to trick Chrome's aggressive autofill */}
